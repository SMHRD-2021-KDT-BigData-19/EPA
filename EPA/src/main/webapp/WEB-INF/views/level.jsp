...
progress::-webkit-progress-bar {background: #eee;} /* Chrome */
progress::-webkit-progress-value {background:#c2c2c2;} /* Chrome */
progress::-moz-progress-bar {background: #eee;} /* Firefox */
progress,
progress[role] {
	appearance: none; 
	-moz-appearance: none; 
	...
	width: 500px; height: 50px; /* 높이값과 넓이값은 맘대로 조정 */
	margin: 10px 0;}
progress[role]:after {background-image: none;}
.levelpro1::-webkit-progress-value {background:green !important;}
.levelpro2::-webkit-progress-value {background:yellowgreen !important;}
/* IE10 이상 */
progress {color:#c2c2c2;}
progress.levelpro1 {color:white !important;}
progress.levelpro2 {color:white!important;}
...
<body>
    ...
    <div class="container">
        ...
        <div class="profile-text">
            ...
            <div class="levelbar">
                <div class="leveltext"><b>출석 수</b></div>
                <progress class="levelpro1" value="60" max="70"></progress>
            </div>
            <div class="levelbar">
                <div class="leveltext2"><b>운동 완료 횟수</b></div>
