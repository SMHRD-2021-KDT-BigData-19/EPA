...
<script>
    ...
    socket.on('exercise_result', function handleExerciseResult(result) {
        ...
        setTimeout(function () {
            ...
            socket.off('exercise_result', handleExerciseResult);

            // 일정 시간이 지난 후에 이벤트 핸들러를 다시 등록
            setTimeout(function () {
                socket.on('exercise_result', handleExerciseResult);
            }, 3000);
        }, 3000);
