...
CREATE TABLE LOGIN_TB (
    BUNHO INT AUTO_INCREMENT PRIMARY KEY, -- BUNHO를 AUTO_INCREMENT로 변경
    MEM_ID VARCHAR(50) NOT NULL,
    ATTEND_COUNT INT DEFAULT 0,
    LAST_ATTEND_DATE DATETIME,
    CONSTRAINT UC_Login UNIQUE (MEM_ID)
);

select * from LOGIN_TB;

INSERT INTO LOGIN_TB (MEM_ID, ATTEND_COUNT) VALUES (?, 1);
...
-- 테이블 정보 보는 곳
SELECT * FROM LOGIN_TB; -- 테이블명 바꾸면 됨
...
-- 테이블 정의에서 기본값이 설정된 경우
ALTER TABLE LOGIN_TB MODIFY COLUMN BUNHO VARCHAR(50) DEFAULT 'someDefaultValue';

-- 데이터 삽입
ALTER TABLE LOGIN_TB
MODIFY COLUMN ATTEND_COUNT INT DEFAULT 1;
